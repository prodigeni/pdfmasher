...
class MOBIOutput(OutputFormatPlugin):
    ...
    def convert(self, oeb, output_path, input_plugin, opts, log):
        ...
        # from ..oeb.transforms.rasterize import SVGRasterizer, Unavailable
        from ..oeb.transforms.htmltoc import HTMLTOCAdder
        # from ..customize.ui import plugin_for_input_format
        ...
        from .writer2.main import MobiWriter
        #     MobiWriter
        # else:
        # from .writer import MobiWriter
        if opts.kindlegen:
            from .kindlegen import kindlegen
        ...
        if opts.extract_to is not None:
            from .debug import inspect_mobi
