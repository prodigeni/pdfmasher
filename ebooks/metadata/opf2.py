...
from ..constants import __appname__, __version__, filesystem_encoding
from .toc import TOC
from . import string_to_authors, MetaInformation, check_isbn
from .book.base import Metadata
from ..utils.date import parse_date, isoformat
from ..utils.localization import get_lang
from ..utils import prints, guess_type
from ..utils.cleantext import clean_ascii_chars
...
class OPF(object): # {{{
    ...
    def __init__(self, stream, basedir=os.getcwdu(), unquote_urls=True,
        ...
        raise Exception('Oops, we use that?')
