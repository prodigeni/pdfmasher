...
from .date import parse_date, format_date, now, UNDEFINED_DATE
...
class BuiltinCmp(BuiltinFormatterFunction):
    ...
    category = 'Relational'
    arg_count = 5
    __doc__ = doc =   'cmp(x, y, lt, eq, gt) -- compares x and y after converting both to '
...
class BuiltinRe(BuiltinFormatterFunction):
    ...
    arg_count = 3
    category = 'String Manipulation'
    __doc__ = doc = 're(val, pattern, replacement) -- return the field after applying '
...
class BuiltinUppercase(BuiltinFormatterFunction):
    ...
    __doc__ = doc = 'uppercase(val) -- return value of the field in upper case'
...
class BuiltinLowercase(BuiltinFormatterFunction):
    ...
    arg_count = 1
    category = 'String case changes'
    __doc__ = doc = 'lowercase(val) -- return value of the field in lower case'
